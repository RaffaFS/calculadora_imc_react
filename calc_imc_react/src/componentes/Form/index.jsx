            ...
            <div className={styles.contentBox}>
                ...
                <div className={styles.formBox}>
                    ...
                    <div className={styles.inputBox}>
                        <input type="number" placeholder="Peso em kg" onChange={e => setPeso(Number(e.target.value))} onKeyUp={resultado} onClick={resultado} />
                        <input type="number" placeholder="Altura em cm" onChange={e => setAltura(Number(e.target.value))} onKeyUp={resultado} onClick={resultado} />
                    </div>
                ...
                <div className={styles.IMCbox}>
                    <div className={`${styles.niveis} ${IMC != 0 && IMC < 18.5 && peso && altura ? styles.selecionado : ''}`}>
                    ...
                    <div className={`${styles.niveis} ${IMC >= 18.5 && IMC <= 24.9 && peso && altura ? styles.selecionado : ''}`}>
                    ...
                    <div className={`${styles.niveis} ${IMC >= 25 && IMC <= 29.9 && peso && altura ? styles.selecionado : ''}`}>
                    ...
                    <div className={`${styles.niveis} ${IMC >= 30 && IMC <= 34.9 && peso && altura ? styles.selecionado : ''}`}>
                    ...
                    <div className={`${styles.niveis} ${IMC >= 35 && IMC <= 39.9 && peso && altura ? styles.selecionado : ''}`}>
                    ...
                    <div className={`${styles.niveis} ${IMC >= 40 && peso && altura ? styles.selecionado : ''}`}>
