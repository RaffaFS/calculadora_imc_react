        ...
        <div className={styles.allBox}>
            <div className={styles.contentBox}>
                ...
                <div className={styles.formBox}>
                    ...
                    <input type="number" placeholder="Seu peso em kg" onChange={e => setPeso(Number(e.target.value))} onKeyUp={resultado} onClick={resultado} />
                    <input type="number" placeholder="Sua altura em cm" onChange={e => setAltura(Number(e.target.value))} onKeyUp={resultado} onClick={resultado} />
